...
- **Facebook `type: "story"` stopped publishing to the timeline.** It had been accepted and then published as an ordinary feed post, which is not what anyone asking for a story wanted. It was briefly refused, and now [publishes as a real story](#facebook-stories). Instagram stories were unaffected throughout.
