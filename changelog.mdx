...
Both platforms respect the same pre-publish validation, auto-transcode, progress states, and webhook events as every other target. See the new [Telegram](/platforms/telegram) and [Discord](/platforms/discord) platform pages.
</Update>
