...
- **Free-form replies inside the 24-hour customer service window are billed as `service`.** WhatsApp does not charge for these today, so the rate is currently zero. That changes on **1 October 2026**, when WhatsApp begins charging for service messages and for utility templates sent inside the window.
