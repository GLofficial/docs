...
<CardGroup cols={2}>
  ...
  <Card title="Developer Dashboard" icon="gauge" href="https://app.smartlyq.com/next/developer">
...
<CardGroup cols={3}>
  ...
  <Card title="CRM & Automations" icon="diagram-project">
    Contacts, pipelines, and automation runs — trigger workflows from your stack.
  </Card>
  <Card title="Reviews" icon="star">
    List, reply to, and sync Google Business reviews programmatically.
  </Card>
  <Card title="Smart Scheduling" icon="calendar-days">
    Posting queues, evergreen recycling, bulk CSV imports, duplicate protection.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Dashboard" icon="gauge" href="https://app.smartlyq.com/next/developer">
