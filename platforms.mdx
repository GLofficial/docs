...
| <Icon icon="telegram" iconType="brands" /> **Telegram** | <Icon icon="check" color="#16a34a" /> | <Icon icon="minus" color="#cbd5e1" /> | <Icon icon="minus" color="#cbd5e1" /> | <Icon icon="minus" color="#cbd5e1" /> | <Icon icon="check" color="#16a34a" /> ³ |
