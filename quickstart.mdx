...
- A SmartlyQ account ([sign up](https://smartlyq.com/signup))
- A **Pro plan or higher** (API access requires Pro+)
- An API key from the [Developer Dashboard](https://smartlyq.com/my/developer)

## Step 1: Get your API key

<Steps>
  <Step title="Open the Developer Dashboard">
    Go to [smartlyq.com/my/developer](https://smartlyq.com/my/developer) and create a new API key.
  </Step>
