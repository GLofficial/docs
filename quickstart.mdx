...
- A SmartlyQ account ([sign up](https://app.smartlyq.com/next/signup))
- A **Pro plan or higher** (API access requires Pro+)
- An API key from the [Developer Dashboard](https://app.smartlyq.com/next/developer)

## Step 1: Get your API key

<Steps>
  <Step title="Open the Developer Dashboard">
    Go to [app.smartlyq.com/next/developer](https://app.smartlyq.com/next/developer) and create a new API key.
  </Step>
