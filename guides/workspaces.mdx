...
<Note>Building a product where **your own customers** connect accounts and never see SmartlyQ? That is [Profiles](/guides/profiles) - per-end-customer sub-accounts with hosted connect links and per-account billing. Workspaces are for agency sub-accounts you manage yourself.</Note>
