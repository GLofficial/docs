...
The simplest path — and the only one for most platforms — is the app itself: open [Social Media → Accounts](https://app.smartlyq.com/next/go/social-media/accounts), choose a platform, and complete the OAuth flow. The account immediately becomes available to the API and appears in `GET /v1/social/accounts`.
